...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x06logger\x18\x03 \x01(\v2\x12.kratos.api.LoggerR\x06logger\"6\n" +
	"\x06Logger\x12\x14\n" +
	"\x05level\x18\x01 \x01(\tR\x05level\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xf1\x03\n" +
	"\x04Data\x125\n" +
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	1,  // 2: kratos.api.Bootstrap.logger:type_name -> kratos.api.Logger
